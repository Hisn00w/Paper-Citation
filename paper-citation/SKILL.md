...
为避免新论文因发表时间短而总被引量偏低，采用**年均被引量**计算：
...
**时间归一化说明：**
- **核心公式**：年均被引量 = 总被引量 / 发表年数，使新旧论文公平可比
- 发表年数 = 当前年份 - 发表年份 + 1（至少为1，当年发表论文为1）
- 乘数因子2用于平衡年均值与总量差异
- 使用对数压缩避免极端高被引论文主导排名

**示例对比：**

| 论文 | 年份 | 总被引 | 发表年数 | 年均被引 | 被引得分 |
|------|------|--------|----------|----------|----------|
| 经典论文A | 2018 | 500 | 8 | 62.5 | 54.9 |
| 新论文B | 2024 | 80 | 2 | 40.0 | 48.2 |
| 当年论文C | 2025 | 25 | 1 | 25.0 | 42.9 |

> 注：新论文B虽然总被引远低于经典论文A，但年均被引接近，得分差距缩小，体现了时间归一化的公平性。
